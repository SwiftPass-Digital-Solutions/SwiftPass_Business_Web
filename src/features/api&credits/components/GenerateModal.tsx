      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
        <div className="w-[92%] max-w-md bg-white rounded-2xl p-6 shadow-lg">
          <div className="flex flex-col items-center gap-4">
            {modalStep !== 3 && (
              <div
                className={`flex flex-col w-[72px] h-[72px] items-center justify-center gap-2.5 p-3 rounded-[52px] ${modalMode === "generate" ? "bg-[#fcf9f1]" : "bg-[#ffefef]"}`}
              >
                {modalMode === "generate" ? (
              ...
              <>
                <div className="flex flex-col w-[280px] items-center gap-1">
                  ...
                  <p className="[font-family:'Archivo',Helvetica] font-normal text-[#6b7280] text-xs tracking-[0] leading-[17.4px]">
                    {modalMode === "generate"
                      ? "Select the type you would like to generate"
                      : "Select the type(s) you would like to revoke"}
                  </p>
                </div>
                  ...
                  <>
                    <div className="flex flex-col items-center gap-1 w-full">
                      ...
                      <p className="[font-family:'Archivo',Helvetica] font-normal text-[#6b7280] text-xs text-center tracking-[0] leading-[17.4px]">
                        ...
                        integrations using this key will immediately stop
                        working
                      </p>
                    </div>
